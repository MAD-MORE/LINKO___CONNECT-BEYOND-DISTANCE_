...
fun LinkoSignUpScreen(auth: LinkoAuth, onRegistered: () -> Unit) {
    ...
    Column(Modifier.fillMaxSize().verticalScroll(rememberScrollState()).padding(horizontal = 16.dp)) {
        ...
        Spacer(Modifier.height(24.dp)); LinkoInput("EMAIL", email, { email = it }, "you@example.com", "Used for your LINKO account")
        ...
        PrimaryButton(when { busy -> "CREATING…"; cooldownActive -> "WAIT…"; else -> "CREATE ACCOUNT" }, {
            ...
            when {
                ...
                password != confirm -> message = "Passwords do not match."
                    ...
                    busy = true; message = null; cooldownUntil = System.currentTimeMillis() + SIGNUP_COOLDOWN_MS
                    scope.launch {
